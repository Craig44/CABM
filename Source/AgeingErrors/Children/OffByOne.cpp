...
OffByOne::OffByOne(Model* model) : AgeingError(model) {
  parameters_.Bind<float>(PARAM_P1, &p1_, "proportion misclassified as one year younger, e.g., the proportion of age 3 individuals that were misclassified as age 2", "")->set_range(0.0, 1.0);
  parameters_.Bind<float>(PARAM_P2, &p2_, "proportion misclassified as one year older, e.g., the proportion of age 3 individuals that were misclassified as age 4", "")->set_range(0.0, 1.0);

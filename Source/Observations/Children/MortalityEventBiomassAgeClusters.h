 ...
 */
#ifndef OBSERVATIONS_MORTALITY_EVENT_AGE_BIOMASS_CLUSTERS_H_
#define OBSERVATIONS_MORTALITY_EVENT_AGE_BIOMASS_CLUSTERS_H_
 ...
 * class definition
 */
class MortalityEventBiomassAgeClusters : public niwa::Observation {
public:
  // methods
  MortalityEventBiomassAgeClusters(Model* model);
  virtual                     ~MortalityEventBiomassAgeClusters();

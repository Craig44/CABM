...
\usepackage[bookmarks=true,bookmarksopen=false,bookmarksnumbered=true,
            ...
            pdftitle={CABM User Manual (Beta Version)}, 
            pdfauthor={C. Marsh} %authors
            pdfsubject={CABM, User manual},
            pdftex]{hyperref}
\hypersetup{
...
\newcommand{\IBM}{\textsc{CABM}} 
\newcommand{\ibm}{\texttt{cabm}} % casal2 binary name
\newcommand{\authors}{C. Marsh}
\newcommand{\authorsTitleFirstLine}{C. Marsh}

%hyper ref for Development Team email
\newcommand{\emaillink}{\href{mailto:"Craig Marsh Team"<craig.marsh10@gmail.com>?subject=IBM:}{\texttt{CABM Development Team}}}                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    
\newcommand{\github}{\url{https://github.com/Craig44/CABM}}
\newcommand{\authorlink}{\href{mailto:"Craig Marsh"<craig.marsh10@gmail.com>?subject=IBM:}{authors}} 
%hyper ref for email
\newcommand{\Organisation}{ } %%NIWA
\newcommand{\ManualRef}{\authors\ (\DocYear). C++ Agent Based Model (CABM) User Manual, \VER. \Organisation\ \emph{ }. \ref{TotPages} p.} % full document reference
...
% Title page
\pdfbookmark[1]{C++ Agent Based Model (CABM) User Manual}{title}
...
\begin{titlepage}
  \thispagestyle{empty} % no header/footer/page number on this page
	\begin{center}
		...
		\vspace*{2.5cm}
		\Huge C++ Agent Based Model (\IBM) User Manual \\

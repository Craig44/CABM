...
An agent is the core object in the state that everything manipulates or summarises. An agent has a list of predefined attributes that the user can choose to incorporate in the model or ignore, the list is below.
...
\begin{itemize}
	...
	\item lat and long
	\item \I{population scalar} how many individuals does this agent represent = 1 means an individual based model (scalar). Will differ for each meta population.

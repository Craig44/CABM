...
\begin{itemize}
	...
	\item lat and long
	\item \I{population scalar} how many other individuals does this represent (weight scalar)
...
Where $t$ is the time steps we have applied the preference movement in annual cycle.

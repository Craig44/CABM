...
FILE = [open('Syntax/DerivedQuantity.tex', 'r'),
...
SYNTAX_OUTFILE = open('IBM.syn', 'w')

OUTFILE.write("\section{Quick reference\label{sec:quick-reference}}\n")
SYNTAX_OUTFILE.write("; TextPad syntax definitions for IBM; This is auto generated from the quickreference.py script do not edit\n")

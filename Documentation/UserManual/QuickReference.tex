...
\defSub{ato95} {Ato95}
\defSub{alpha} {Alpha}
\defComLab{layer}{Define an object of type \emph{layer}}\par\par
\defSub{label} {Label of the Layer}
\defSub{type} {Type of Layer}
\par\textbf{\commandlabsubarg{layer}{type}{int\_layer}}\par
\par\textbf{\commandlabsubarg{layer}{type}{numeric\_meta\_layer\_numeric}}\par
\defSub{proportions} {Is this layer proportion values?}

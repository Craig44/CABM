...
\defSub{latitude\_bounds} {Label for the latitude layer}
\defSub{longitude\_bounds} {Label for the longitude layer}
...
\defSub{catchability} {The Catchability to use to scale the observation for vulnerability}
\defSub{time\_step} {The label of time-step that the observation occurs in}
\defSub{years} {The years of the observed values}
...
\par\textbf{\commandlabsubarg{process}{type}{movement\_box\_transfer\_movement}}\par
\par\textbf{\commandlabsubarg{process}{type}{movement\_preference\_movement}}\par
